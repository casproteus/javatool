...
public class Alarmer extends JFrame implements ComponentListener, WindowListener, ActionListener, WindowStateListener{
	...
	static final String ST1 = "gui jiao";
	static final String ST2 = "zhu jiao";
	static final String ST3 = "gou jiao";
	static final String ST4 = "mao jiao";
	static final String ST5 = "ren jiao";
	...
	public static void tone(String toneType) throws LineUnavailableException {
		switch(toneType){
		case ST1:
			Alarmer.tone(1000, 100, 1.0);
			break;
		case ST2:
			Alarmer.tone(100, 1000, 1.0);
			break;
		case ST3:
			Alarmer.tone(5000, 100, 1.0);
			break;
		case ST4:
			Alarmer.tone(400, 500, 1.0);
			break;
		case ST5:
							...
							if(isInWaiting){
								...
								try{
									for(int i = 0; i < times; i++){
										if(!isInWaiting) break;
										Alarmer.tone(soundType.getSelectedItem().toString());
										Thread.sleep(1000);
									}									
								}catch(Exception e){
